...
{-# LANGUAGE TypeData #-}
module GHC.Wasm.Web.Generated.OptionalEffectTiming.Core (
        OptionalEffectTimingFields, OptionalEffectTimingClass,
        OptionalEffectTiming, ReifiedOptionalEffectTiming
    ) where
import Data.Int
import Data.Word
...
type OptionalEffectTimingFields =
...
type OptionalEffectTimingClass =
    JSDictionaryClass OptionalEffectTimingFields
type OptionalEffectTiming = JSObject OptionalEffectTimingClass
type ReifiedOptionalEffectTiming =
    ReifiedDictionary OptionalEffectTimingFields
