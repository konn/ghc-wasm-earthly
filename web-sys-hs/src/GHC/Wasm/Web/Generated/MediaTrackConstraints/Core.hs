...
{-# LANGUAGE TypeData #-}
module GHC.Wasm.Web.Generated.MediaTrackConstraints.Core (
        MediaTrackConstraintsFields, MediaTrackConstraintsClass,
        MediaTrackConstraints, ReifiedMediaTrackConstraints
    ) where
import Data.Int
import Data.Word
...
import GHC.Wasm.Web.Generated.MediaTrackConstraintSet.Core
import GHC.Wasm.Web.Types
type MediaTrackConstraintsFields =
    '[ '("advanced",
         NullableClass (SequenceClass MediaTrackConstraintSetClass)),
...
type MediaTrackConstraintsClass =
    JSDictionaryClass MediaTrackConstraintsFields
type MediaTrackConstraints = JSObject MediaTrackConstraintsClass
type ReifiedMediaTrackConstraints =
    ReifiedDictionary MediaTrackConstraintsFields
