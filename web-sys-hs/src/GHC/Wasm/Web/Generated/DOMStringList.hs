...
{-# LANGUAGE TypeData #-}
module GHC.Wasm.Web.Generated.DOMStringList (
        DOMStringList, DOMStringListClass,
        js_fun_contains_DOMString_boolean, js_get_length
    ) where
import Data.Int
import Data.Word
