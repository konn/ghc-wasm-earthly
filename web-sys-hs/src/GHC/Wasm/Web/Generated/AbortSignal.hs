...
{-# LANGUAGE TypeData #-}
module GHC.Wasm.Web.Generated.AbortSignal (
        AbortSignal, AbortSignalClass, js_get_aborted, js_get_onabort,
        js_set_onabort
    ) where
import Data.Int
import Data.Word
