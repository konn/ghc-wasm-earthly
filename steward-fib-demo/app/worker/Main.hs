...
buildResponseBody mcf req = do
  ...
  html_ $ do
    ...
    body_ $ do
      ...
      p_ do
        input_ [type_ "text", name_ "fib-input", placeholder_ "12"]
  ...
  script_ [type_ "text/javascrip"] startupScript
...
startupScript =
  LT.unlines
    ...
    , "  const result = await fetch(\"./fib/${num}\").json();"
